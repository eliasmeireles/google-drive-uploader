...
import (
	...
	"github.com/eliasferreira/google-driver-uploader/internal/app"
...
Supports large files, automatic folder organization, and resumable uploads.`,
	...
	// Flags
	rootCmd.Flags().StringVar(&cfg.ClientSecret, "client-secret", "", "Path to the OAuth 2.0 client secret file (optional if exists in /etc/google-driver-uploader/ or if token.json has embedded credentials)")
